...
@Component({
  selector: 'app-visitors-by-country-chart',
  templateUrl: './visitors-by-country-chart.component.html',
  styleUrls: ['./visitors-by-country-chart.component.scss']
})
export class VisitorsByCountryChartComponent implements OnInit {
